 ...
 * @method static void trackConversion(string $eventName, Context|array<string, mixed>|null $context = null, array<string, mixed> $properties = [], ?string $flagKey = null, bool|int|float|string|array<string, mixed>|null $flagValue = null)
